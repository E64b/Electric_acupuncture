...
void loop(){
	...
	if((millis()-TIMER>=1000) or (FIRST)){
		TIMER=millis(); //Reset timer

		lcdRedraw=true; //Redraw LCD
	...
	if(lcdRedraw or FIRST){
		lcdRedraw=false;
		FIRST=false;
		lcd.clear();
		lcd.home();	lcd.print("PIN"); lcd.print(' '); lcd.print('Q'); lcd.print(CURRENT_PIN);
		lcd.setCursor(0, 1); lcd.print("OF"); lcd.print(' '); lcd.print(ALL_DATA);
		}
	}